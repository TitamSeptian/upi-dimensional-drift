...
<html lang="en">
    ...
    <body>
        <header
            class="bg-transparant absolute top-0 left-0 w-full flex z-10 lg:px-10 py-3"
        >
            <div class="container">
        ...
        <section id="home" class="h-screen w-full -mt-10">
            <div
                class="flex items-center justify-center h-screen flex-col gap-y-16"
            >
                <h1
                    class="sm:text-6xl text-3xl font-bold tracking-wider text-center"
                >
                ...
                <a
                    href=""
                    class="block px-11 font-semibold py-2 bg-color1 text-white rounded-lg text-2xl hover:scale-105 transition-all duration-300 ease-in-out"
                >
                    See the campus
                </a>
            </div>
        ...
        <section id="about" class="overflow-hidden sm:px-10 px-2">
            <div
                class="flex flex-wrap md:flex-nowrap bg-color3 text-white items-center rounded-2xl relative overflow-hidden"
            >
                <div
                    class="md:order-1 order-2 md:basis-1/3 flex flex-col gap-4 px-4 py-6"
                >
                ...
                <div class="md:order-2 md:basis-2/3 flex relative w-full">
                    <img
                        src="/public/images/about/about-upi.png"
                        alt="foto upi"
                        class="w-fit"
                    />
                </div>
        ...
        <section id="features" class="overflow-hidden my-24">
            <div
                class="flex items-center text-white justify-center gap-5 flex-wrap md:flex-nowrap"
            >
                <div
                    class="bg-color1 flex px-5 py-8 rounded-2xl gap-x-4 md:basis-96 basis-11/12"
                >
                    <img
                        src="/public/images/about/icon-360.png"
                        alt="features 1"
                    />
                ...
                >
                    <img
                        src="/public/images/about/icon-info.png"
                        alt="features 2"
                    />
                    <div class="flex flex-col gap-y-3 justify-center">
