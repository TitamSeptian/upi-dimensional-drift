...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/public/vendor/pannellum/pannellum.css" />
    ...
    <body>
            ...
            <div class="container">
                <div class="flex items-center justify-between relative">
                    ...
                    <div class="flex items-center px-4">
                        ...
                        <nav
                            id="nav"
                            class="hidden z-[99999] py-5 absolute lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full"
                        >
            ...
            <div class="container-xx">
                <div class="info-destination active">
                    <div class="content font-semibold">
                        ...
                        <button
                            class="py-3 px-8 bg-color1 text-white font-semibold rounded-xl"
                        >
                ...
                <div class="buttons in">
                    ...
                    ><br />
                    <button
                        onclick="p360.toggleFullscreen()"
                        title="Lihat 360 Secara Fullscreen"
                    >
        ...
        <section id="detail">
            <div class="flex flex-col sm:p-10 gap-y-5 px-5 py-10">
                ...
                <div class="facility flex flex-col gap-y-4">
                    ...
                    >
                        <div
                            class="facility-item flex gap-x-2 shadow justify-center items-center py-3 rounded-xl"
                        >
                ...
                <div class="more-image flex flex-col">
                    <h1 class="font-semibold text-2xl">Gambar lain</h1>

                    <div
                        class="grid grid-cols-1 gap-4 md:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3"
                    >
        ...
        <script src="/public/vendor/pannellum/pannellum.js"></script>
