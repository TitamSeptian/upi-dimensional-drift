        ...
        <div class="container">
            <div class="flex items-center justify-between relative">
                ...
                <div class="flex items-center px-4">
                    ...
                    <nav id="nav" class="hidden z-[99999] py-5 absolute lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full">
                        <ul class="block sm:flex font-semibold">
                            ...
                            <li class="group">
                                <a href="roomt-tour.php" class=" py-2 mx-8 flex group-hover:text-color2">Room Tour</a>
                            </li>
                            <li class="group">
        ...
        <div class="flex flex-col sm:p-10 gap-y-5 px-5 py-10">
            ...
            <div class="facility flex flex-col gap-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 sm:grid-cols-2 gap-4">
                    <div class="facility-item flex gap-x-2 justify-center items-center py-3 rounded-xl hover:shadow-md transition-all duration-200 border hover:cursor-pointer">
