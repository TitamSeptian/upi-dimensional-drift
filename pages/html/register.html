...
<html lang="en">
    ...
    <body>
        <section id="login">
            <div
                class="flex items-center w-screen h-screen justify-center bg-[url('/public/images/login/background.png')] bg-cover"
            >
                <div
                    class="bg-white shadow-md rounded-xl px-8 pt-6 pb-8 mb-4 flex flex-col w-[500px]"
                >
