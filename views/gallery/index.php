...
<form id="formGallery" action="<?= base_url()?>/resources/php/gallery/store.php" method="POST" class="mt-5  rounded-2xl absolute left-0 right-0 ml-auto mr-auto  w-4/5 md:w-3/4 bg-white hidden top-0 drop-shadow-2xl z-50 ">
    ...
    <div id="formContainer" class="p-5 ">
        <div class="form-control">
            ...
            <input type="file" class="input border p-2 border-slate-500" name="image" >
        </div>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b">
                        ...
                        <td class="td max-w-sm truncate">
                            <img src="https://hollux.herokuapp.com/storage/img/avatar/a.pngs"
                                class="w-10 h-10 object-cover rounded-tr-xl rounded-bl-xl" alt=<?= $image?>>
                        </td>
                        <td class="td font-medium text-gray-900"><?=$path?></td>
