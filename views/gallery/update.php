...
<form id="formGallery" action="<?= base_url()?>/resources/php/gallery/update.php" method="POST" class=" border rounded-t-2xl">
    ...
    <div id="formContainer" class="p-5 ">
        ...
        <div class="form-control">
            ...
            <input type="file" class="input border p-2 border-slate-500" name="image" required>
        </div>
