...
<html lang="en">
    ...
    <body>
        <header
            class="bg-transparant top-0 left-0 w-full flex z-10 lg:px-10 py-3"
        >
            <div class="container">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            d="M402.964 364.73L364.129 403.564C331.862 413.866 297.492 415.724 264.302 408.96C231.112 402.195 200.211 387.035 174.549 364.927C196.234 376.424 220.554 382.035 245.084 381.198C298.234 390.01 352.777 384.321 402.964 364.73Z"
                                            fill="white"
                                        />
                                    </g>
                                </g>
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            d="M106.513 196.615C106.496 196.894 106.462 197.172 106.412 197.447C101.326 213.422 99.114 230.173 99.8801 246.921C97.115 285.888 100.178 340.894 122.113 408.834L93.6466 380.362C90.3779 372.987 87.6048 365.404 85.3458 357.66C84.845 356.03 84.3814 354.362 83.8806 352.727C83.0815 349.53 82.2823 346.392 81.611 343.195C80.945 340.126 80.311 337.095 79.7782 333.962C79.2454 330.829 78.8458 327.691 78.4462 324.558C78.0466 321.426 77.7803 318.292 77.5458 315.192C77.3114 312.091 77.1462 308.927 77.077 305.725C77.0077 302.522 76.9811 299.422 77.077 296.257C77.2102 289.991 77.6471 283.689 78.377 277.423C79.0802 271.253 80.1138 265.169 81.3765 259.085C81.4106 258.926 81.457 258.771 81.5151 258.621C82.1438 255.589 82.911 252.553 83.6462 249.564C83.7197 249.419 83.765 249.262 83.7794 249.1L84.9782 244.896C86.0437 241.294 87.1786 237.762 88.4466 234.24C89.0113 232.541 89.6773 230.874 90.3113 229.174C91.1158 227.107 91.947 225.008 92.8154 223.005C94.1793 219.84 95.6125 216.669 97.115 213.574C97.9461 211.938 98.8146 210.207 99.715 208.571C100.276 207.362 100.898 206.183 101.58 205.039C103.141 202.183 104.776 199.348 106.513 196.615Z"
                                            fill="white"
                                        />
                                    </g>
                                </g>
                                ...
                                <g style="mix-blend-mode: screen" opacity="0.4">
                                    ...
                                    >
                                        <path
                                            d="M82.9027 278.024C82.8708 277.923 82.94 277.853 82.9027 277.821L82.94 277.853L82.9027 278.024Z"
                                            fill="white"
                                        />
                                    </g>
                                </g>
                                <g style="mix-blend-mode: screen" opacity="0.4">
                                    ...
                                    >
                                        <path
                                            d="M202.348 83.2383L204.282 83.8403H203.946C203.383 83.7354 202.842 83.5313 202.348 83.2383Z"
                                            fill="white"
                                        />
                                    </g>
                                </g>
                                <g style="mix-blend-mode: screen" opacity="0.4">
                                    ...
                                    >
                                        <path
                                            d="M227.047 86.2051L227.515 86.4023C227.354 86.35 227.197 86.284 227.047 86.2051Z"
                                            fill="white"
                                        />
                                    </g>
                                </g>
                                <g style="mix-blend-mode: screen" opacity="0.4">
                                    ...
                                    >
                                        <path
                                            d="M228.021 86.5042L230.418 86.2378C230.189 86.363 229.943 86.453 229.688 86.5042C229.431 86.5926 229.161 86.6379 228.889 86.6374H228.75L228.021 86.5042Z"
                                            fill="white"
                                        />
                                    </g>
                                </g>
        ...
        <section id="header" class="h-full overflow-hidden">
            <div class="h-[425px] relative w-full">
                <img
                    src="/public/images/gallery/labkomRPL.jpeg"
                    alt=""
                    class="w-full h-full absolute object-cover inset-0 -z-10 brightness-50"
                />
                <div
                    class="flex flex-col w-full h-full justify-center items-center sm:items-start text-white px-4 sm:px-10"
                >
                    <h1 class="font-semibold">About Us</h1>
                    <h1 class="font-bold text-4xl">UPI</h1>
                    <h1 class="font-bold text-4xl">Dimensional Drift</h1>
                    <p class="font-light text-center sm:text-left">
        ...
        <section class="py-10">
            <div class="px-4 sm:px-10 py-10">
                <p>
                    Take reference from the ultimate agent valorant (Yoru), the
                    power to see between dimensions that cannot be affected or
                    seen by outside entities. This is certainly in line with the
                    vision of a virtual web tour that has the purpose and
                    benefits to provide the user experience entering the
                    dimensions of the virtual world upi campus cibiru with
                    sensations such as being in an actual and real campus
                    environment.Web virtual tour that has the purpose and
                    benefits to provide users with the experience of entering
                    the virtual world dimension of the UPI Cibiru campus with a
                    sensation like being in an actual and real campus
                    environment
                </p>
            </div>
            <div
                class="grid grid-cols-1 px-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:px-10"
            >
                <div
                    class="flex flex-col px-16 py-6 gap-y-3 rounded-xl group hover:shadow transition-all duration-200"
                >
                    <img
                        src="/public/images/teams/riyandi.png"
                        alt="team"
                        class="w-full"
                    />
                    <h4 class="font-semibold">Riyandi Firman</h4>
                    <p>Web Developer</p>
                ...
                >
                    <img
                        src="/public/images/teams/rony.png"
                        alt="team"
                        class="w-full"
                    />
                    <h4 class="font-semibold">Rony Wahyu</h4>
                    <p>Web Developer</p>
                    <div class="flex gap-x-2 text-2xl">
                        <a href="" class="">
                            <i class="bx bxl-twitter"></i>
                ...
                >
                    <img
                        src="/public/images/teams/fikri.png"
                        alt="team"
                        class="w-full"
                    />
                    <h4 class="font-semibold">Fikri Habib</h4>
                    <p>Web Developer</p>
                    <div class="flex gap-x-2 text-2xl">
                        <a href="" class="">
                            <i class="bx bxl-twitter"></i>
                ...
                >
                    <img
                        src="/public/images/teams/septian.png"
                        alt="team"
                        class="w-full"
                    />
                    <h4 class="font-semibold">Septian Pradipta</h4>
                    <p>Web Developer</p>
                    <div class="flex gap-x-2 text-2xl">
                        <a href="" class="">
                            <i class="bx bxl-twitter"></i>
        ...
        <footer id="footer" class="text-white tracking-wide">
            <div class="flex bg-color1 p-10 flex-wrap sm:flex-nowrap gap-y-10">
                <div
                    class="sm:order-1 order-2 sm:basis-1/2 flex gap-y-2 flex-col"
                >
                ...
                <div
                    class="sm:order-2 order-1 sm:basis-1/2 flex flex-col items-end"
                >
                    <ul
                        class="flex sm:justify-between flex-col sm:flex-row gap-y-4 sm:gap-x-10 py-3 font-semibold"
                    >
                        <li>Home</li>
                        <li>About</li>
                        <li>Room Tour</li>
